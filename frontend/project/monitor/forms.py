...
class SelectDateForm(forms.Form):
    im_start_date = forms.DateField(label="start date", widget=MyDateInput, initial='2023-01-01')
    ...
    sm_start_date = forms.DateField(label="start date", widget=MyDateInput, initial='2023-01-01')
    ...
    sys_start_date = forms.DateField(label="start date", widget=MyDateInput, initial='2023-01-01')
    ...
    all_start_date = forms.DateField(label="start date", widget=MyDateInput, initial='2023-01-01')
